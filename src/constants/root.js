...
export const ROOT_SIDEBAR = document.querySelector('#sidebar');
...
export const ROOT_SELECT = document.querySelector('#select');
export const ROOT_SIDEBAR_NOTES = document.querySelector('#sidebarnotes');
